 ...
 */
// Made this a comment: let friends = 56
 ...
 */
print ("Friends is a constant, therefore the value cannot be changed in one execution of code. In order to change the number of friends, I have to make it a variable.")
